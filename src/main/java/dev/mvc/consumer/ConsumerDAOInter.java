...
public interface ConsumerDAOInter {
  ...
  public int GetKey(HashMap hashmap);
   ...
   * @return
   */
  public ArrayList<ConsumerVO> list_by_search_paging(HashMap<String, Object> map);
