...
<DIV class='title_line'>장바구니 등록</DIV>
...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
  ...
  <div class="form-group">
     <label class="control-label col-md-3">장바구니 출력 순서</label>
     <div class="col-md-9">
       <input type='number' name='catebag_seqno' value='1' required="required" 
                 placeholder="${catebag_seqno }" min="1" max="1000" step="1" 
                 style='width: 30%;' class="form-control" >
     </div>
     </div>
      <div class="form-group">
     <label class="control-label col-md-3">장바구니 수량</label>
     <div class="col-md-9">
       <input type='number' name='catebag_seqno' value='1' required="required" 
                 placeholder="${catebag_cnt }" min="1" max="1000" step="1" 
                 style='width: 30%;' class="form-control" >
     </div> 
  </div>  
