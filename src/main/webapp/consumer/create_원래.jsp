...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    $("#consumer_id, #txt_enterpw, #txt_enterpw_confirm, #mobile_tel2, #mobile_tel3, #email1").bind("keypress", function (e) { 
        ...
        // 한글입력방지
        $("#consumer_id, #txt_enterpw, #txt_enterpw_confirm, #mobile_tel2, #mobile_tel3, #email1").css("ime-mode", "disabled");
...
<FORM name='frm' method='POST' action='./create.do' class="form-horizontal">
  <input type='hidden' name='grade_no' id='grade_no' value='0'>
    ...
    <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='consumer_name' id = "consumer_name" value='' required="required" 
  ...
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='consumer_id' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type="password" name='consumer_passwd' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type="text" name='consumer_nickname' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='consumer_email' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     <label class="control-label col-md-3">나이</label>
     <div class="col-md-9">
       <input type='text' name='consumer_age' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='consumer_phone_num' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     ...
     <div class="col-md-9">
       <input type='text' name='consumer_pay_num' value='' required="required" 
                  autofocus="autofocus" class="form-control" style='width: 50%;'>
     </div>
  </div>
  <div class="form-group">
     <label class="control-label col-md-3">게임 성향</label>
     <div class="col-md-9">
        <select name='consumer_game_tend' class="form-control" style='width: 20%;'>
          <option value='1' selected="selected">FPS</option>
          <option value='2'>RPG</option>
          <option value='3'>스포츠</option>
          <option value='4'>레이싱</option>
