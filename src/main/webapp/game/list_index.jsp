    ...
    <div class="" style="height: 300px; width: 95%; margin: 0px auto;">
      <div style="border: solid 2px #999999; ">
        ...
        <c:if test="${gameVO.game_image != null }">
          <a href="http://172.16.12.9:9090/team5/game/read1.do?game_gameno=${gameVO.game_gameno}">
          <img style=" width: 100%;  right: 2px; margin-bottom: 20px; height: 110px;" src="http://172.16.12.9:9090/team5/game/storage/images/${gameVO.game_image }">
          </a> 
        </c:if>
        <c:if test="${gameVO.game_image == null }">
          <a href="http://172.16.12.9:9090/team5/game/read1.do?game_gameno=${gameVO.game_gameno}">
          <img style=" width: 100%;  right: 2px; margin-bottom: 20px; height: 110px;" src="http://172.16.12.9:9090/team5/game/images/none1.png">
          </a> 
        </c:if>
        </div>
