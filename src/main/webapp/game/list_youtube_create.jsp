...
<jsp:include page="/menu/top3.jsp" flush='false' />
  ...
  <ASIDE style='float: left;'>
     ${kindVO.kind_kindname } > ${gameVO.game_title} 관련 Youtube 등록
  </ASIDE>
  ...
  <DIV style='width: 100%;'>
    <FORM name='frm' id='frm' method='POST' action='./list_youtube_create.do' 
      ...
      <div class="form-group">   
        <div class="col-md-12">
          <textarea class="form-control" name='game_youtube' id='game_youtube' rows='6' placeholder="Youtube에서 복사된 소스"></textarea>
        </div>
      </div>
  ...
  <HR>
  <H3>[참고] Youtube 등록 방법</H3>
  <IMG src='./images/youtube01.jpg' style='width: 60%;'><br><br>
