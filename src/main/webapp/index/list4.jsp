...
<form name='frm_all' id='frm_all' method='post' action='./index/update.do'>
  <table id='index_img_all' class="table table-hover" style='margin-bottom: 0px;  '>
    <colgroup>
      <col style='width: 20%;'/>
      <col style='width: 10%;'/>
      <col style='width: 40%;'/>
   ...
   <tr id ='trall${index_img_no}'>   
        ...
        <a href='javascript:index_imgupdate("전체",${index_img_no },"${index_img_fupname }","${index_img_fname }","${index_img_url }","${index_img_division}","${index_img_rdate.substring(0,10) }" )'>수정</A>      
        /
