...
function send1() {
  ...
  if(frm2.openspace_title.value.trim().length == 0){
    alert('제목을 입력해 주세요')
   
    frm2.openspace_title.focus();
    return false//실행 중지
  }
  if(frm2.openspace_title.value.trim().length > 50){
    alert('제목은 50자 이내로 해주세요')
    frm2.openspace_title.focus();
    return false//실행 중지
  }

  if(CKEDITOR.instances.openspace_content.getData().length==0){
    alert('내용을 입력해 주세요')
    CKEDITOR.instances.openspace_content.focus();
    return false
  }
...
<td rowspan="2" style='width: 85%; border-left: solid 1px #999999;'>
      ...
      <div class="" style="">
        <div style="font-size: 30px; font-weight: bold; margin-left: 40px; margin-bottom: 10px; padding-top: 15px;">
          공지사항 등록 &nbsp;</div>
        <form name='frm' id='frm2' method="post" action="./create.do" enctype="multipart/form-data" >
                ...
                <div style="margin-left: 30px;">
                  ...
                  <div>
                    <span style="font-weight: bold;">제목 &nbsp;</span> <input
                      ...
                      name='openspace_title' id='openspace_title'>
                  </div>
                  <br>                  
<!--                  
                  <div>
...
-->                
                  ...
                  <div>
                    <span style="font-weight: bold;">구분 &nbsp;</span> <select
                      name='openspace_division' id='openspace_division'
                  ...
                  <div>
                    <span style="font-weight: bold;">출력 &nbsp;</span> <select
                      name='openspace_visible' id='openspace_visible'
                ...
                <div style='margin-top: 20px;' >
                  ...
                  <input type='text' style="width: 70%;" name='openspace_youtube' id='openspace_youtube'>
           ...
           <div class="input_wrap"  style='margin-top: 30px; '>   
             <div class='imgs_wrap'  style='border: solid 1px #000000;width: 78%; margin-left: 67px;'>
               ...
               <input type='file' class="form-control" name='fnamesMF'  id='input_imgs' 
                          value='' placeholder="파일 선택" multiple="multiple" style='background-color: #111923; color:#c7d5e0;'>
            </div>
          </div> 
