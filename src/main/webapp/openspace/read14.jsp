...
function replyupdate(no, content, pk) {
  ...
  tag += "<button onclick='javascript:reply_create()' style='padding: 7px;' type='submit'>등록</button> <button style='padding: 7px;' type='button' onclick='javascript:noreplyupdate("+no+","+aa+")'>취소</button> </div>";
