  ...
  $.ajax({
    ...
    success: function(rdata) { // 서버로부터 성공적으로 응답이 온경우
      ...
      for (i=0; i < rdata.listgrp.length; i++) {
       ...
       msg+="<a href='#' onclick="+a+"document.getElementById('grpupdate').style.display='block', update("+row.questiongrp_no+", "+b+row.questiongrp_name+b+", "+row.questiongrp_seqno +")"+a+">수정</a>"
       msg+="</td>"
       msg+="</tr>";    
      }
