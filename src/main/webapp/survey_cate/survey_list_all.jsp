...
<TABLE class='table table-borderless table-dark'>
  ...
  <tbody>
  <c:forEach var="survey_categrp_Cate_VO" items="${list }">  <!-- request 객체에 접근 -->
    <c:set var="survey_categrp_name" value="${survey_categrp_Cate_VO.survey_categrpVO.survey_name}" />
    <c:set var="survey_cateno" value="${survey_categrp_Cate_VO.survey_cateVO.survey_cateno}" />
    <c:set var="survey_name" value="${survey_categrp_Cate_VO.survey_cateVO.survey_name}" />
    <c:set var="survey_rdate" value="${survey_categrp_Cate_VO.survey_cateVO.survey_rdate}" />
    
    <TR>
      <TD class="td_bs">${survey_categrp_name }</TD>
